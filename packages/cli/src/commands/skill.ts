  ...
  return [
    {
      ...
      skillPath: join(home, ".claude", "skills", "tempque", "SKILL.md"),
    },
    {
      id: "codex",
      name: "Codex",
      dir: codexHome,
      skillPath: join(codexHome, "skills", "tempque", "SKILL.md"),
    },
  ];
}
...
export function registerSkillCommand(program: Command) {
  const skill = program
    .command("skill")
    .description("Manage TempQue AI agent skill");

  skill
    .command("install")
    .description("Install TempQue skill to AI agent platforms")
    .option(
      "--platform <platform>",
